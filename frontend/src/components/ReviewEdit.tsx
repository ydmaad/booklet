  ...
  return (
    <div>
      ...
      <div className="flex flex-row gap-10 items-center justify-center mb-40">
        <button
          onClick={() => navigate('/')}
          className="bg-white text-gray-600 text-xl text-center w-[130px] py-3 rounded-lg shadow-lg shadow-gray-400 hover:bg-gray-100 transition-colors duration-200"
        >
          취소
        </button>
        <button
